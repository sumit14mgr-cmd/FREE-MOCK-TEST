const database = {
    "jan_2026": {
        "bihar_special_1": [
            ...
            { 
                qh: "बिहार राज्य police सम्मेलन 2026 का आयोजन कहाँ किया गया?", 
...
// 1. Current Affair Button -> Show Months
function showSetView() {
    showView('set-view');
}

// 2. Month Click (Jan 2026) -> Load Data & Show Settings
...
function finishQuiz() {
    ...
    document.getElementById('analysis-box').innerHTML = wrongIdxs.length ? aHtml : "🌟 Perfect Score! No weak areas.";
}
